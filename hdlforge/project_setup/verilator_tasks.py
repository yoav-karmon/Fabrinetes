            ...
            case "build" | "sim":
                try:
                    ...
                    if s == "sim":  
                        ...
                        test_output_dir = build_dir / SimTargetName
                        ...
                        print(f"    • {test_output_dir}/{SimTargetName}_results.md  - Test report (if generated by test)")
                        print(f"    • {test_output_dir}/{SimTargetName}_packets.pcap - Packet capture (if generated by test)")
                        print(f"    • {test_output_dir}/{SimTargetName}_tshark_output.txt - Tshark validation (if generated by test)")
